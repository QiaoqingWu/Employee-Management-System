<!-- 
	...
	Description: a page to view details of a row of record
-->
<?php
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <?php if (!empty($image)): ?>
                        <p><img src="images/<?php echo $image; ?>" alt="<?php echo $name; ?>'s Profile Image" style="max-width: 100%; max-height: 300px;"></p>
                        <?php else: ?>
